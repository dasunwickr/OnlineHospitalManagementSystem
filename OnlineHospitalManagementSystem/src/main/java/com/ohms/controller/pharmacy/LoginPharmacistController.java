...
/**
 * Servlet implementation class LoginPharmacistController
 */
...
public class LoginPharmacistController extends HttpServlet {
     ...
     */
    public LoginPharmacistController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isVaild = pharmacistDAO.isValidPharmacist(UserName, Password);
